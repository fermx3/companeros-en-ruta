...
export async function GET(
  ...
  try {
    ...
    console.error('Error en GET /api/asesor-ventas/orders/[id]:', error)
...
export async function PUT(
  ...
  try {
    ...
    // 7. Validar transiciones de estado permitidas
    ...
    // 8. Preparar datos de actualizacion
    ...
    if (requested_delivery_date !== undefined) updateData.requested_delivery_date = requested_delivery_date
    if (client_notes !== undefined) updateData.client_notes = client_notes
    if (internal_notes !== undefined) updateData.internal_notes = internal_notes
    if (priority !== undefined) updateData.priority = priority

    // 9. Actualizar la orden
    ...
    console.error('Error en PUT /api/asesor-ventas/orders/[id]:', error)
    const errorMessage = error instanceof Error ? error.message : 'Error desconocido'
