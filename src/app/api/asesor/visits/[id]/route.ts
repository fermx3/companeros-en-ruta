...
// GET /api/asesor/visits/[id] - Get a single visit
...
// PUT /api/asesor/visits/[id] - Update a visit
export async function PUT(
  ...
  try {
    ...
    // First verify the visit belongs to this advisor
    ...
    console.error('Error en PUT /api/asesor/visits/[id]:', error)
    const errorMessage = error instanceof Error ? error.message : 'Error desconocido'
